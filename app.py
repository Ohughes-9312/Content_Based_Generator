...
def load_data():
    try:
        ...
        print("Data Loaded:", dataset.head())  # Debug: Print first few rows
        return dataset
...
def vectorize_text(data):
    ...
    print("TF-IDF Matrix Shape:", tfidf_matrix.shape)  # Debug: Print matrix shape
...
def compute_similarity(user_input, vectorizer, tfidf_matrix):
    ...
    print("Cosine Similarities:", cosine_similarities)  # Debug: Print similarities
...
def filter_data(data, genre=None, min_rating=None):
    ...
    print("Filtered Data Shape:", filtered_data.shape)  # Debug: Print filtered data shape
